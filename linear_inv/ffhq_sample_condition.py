...
from guided_diffusion.guided_gaussian_diffusion import create_sampler  # changed to search guided gaussian diffusion
...
def main():
    ...
    for i, ref_img in enumerate(loader):
        ...
        act_img = clear_color(ref_img)
        recon_img = clear_color(sample)
    ...
    # log metrics
    results = evaluator.report(images, y, samples)
