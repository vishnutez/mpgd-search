    ...
    def p_sample_loop(self,
        ...
        for idx in pbar:
            ...
            if search_algo is not None and forward_step % search_algo.resample_rate == 0 and forward_step < end_resample*self.num_timesteps:
                ...
                if perform_lookahead and idx > num_lookahead_steps * jump_size:
                    ...
                    if not jump_la:
                        ...
                        lookahead_steps = list(range(idx, 0, -jump_size))
                        lookahead_steps = lookahead_steps[:num_lookahead_steps]
                        lookahead_steps = lookahead_steps[::-1]  # forward steps
                    # print('lookahead_steps: ', lookahead_steps)

                    if record_inside_la:
                        if forward_step % 40 == 0:
                            record_la = True
                        else:
                            record_la = False
                    else:
