...
python batched_ffhq_coarse_lookahead.py \
        ...
        --scale=4 \
        --method="mpgd_wo_proj" \
        --save_dir='./outputs_paper/super_resolution_6x/mpgd/' \
        --n_images=70 \
        --temp=0.05  \
        --num_particles=1 \
        --batch_size=8 \
...
python batched_ffhq_coarse_lookahead.py \
        ...
        --scale=4 \
        --method="mpgd_wo_proj" \
        --save_dir='./outputs_paper/super_resolution_6x/grad/' \
        --n_images=70 \
        --temp=0.05  \
        --num_particles=1 \
        --batch_size=8 \
...
python batched_ffhq_coarse_lookahead.py \
        ...
        --scale=4 \
        --method="mpgd_wo_proj" \
        --save_dir='./outputs_paper/super_resolution_6x/best_of_n/' \
        --n_images=70 \
        --temp=0.05  \
        --num_particles=8 \
        --batch_size=8 \
...
python batched_ffhq_coarse_lookahead.py \
        ...
        --scale=4 \
        --method="mpgd_wo_proj" \
        --save_dir='./outputs_paper/super_resolution_6x/global_search/' \
        --n_images=70 \
        --temp=0.05  \
        --num_particles=8 \
        --batch_size=8 \
...
python batched_ffhq_coarse_lookahead.py \
        ...
        --scale=4 \
        --method="mpgd_wo_proj" \
        --save_dir='./outputs_paper/super_resolution_6x/group_search/' \
        --n_images=70 \
        --temp=0.05  \
        --num_particles=8 \
        --batch_size=8 \
