...
from guided_diffusion.jump_lookahead_search_guided_gaussian_diffusion import create_sampler  # changed to search guided gaussian diffusion
...
def main():
    ...
    if args.perform_lookahead:
        if args.conditional_lookahead:
            ...
            dir_path += f"_jump_{args.jump_size}_la_{args.num_lookahead_steps}"
